      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100">
          <div class="card custom-card">
            <img src="{{ asset('images/artikel/artikel.jpg') }}" class="card-img-top zoom" alt="Smart Farming Image">
            <div class="card-body">
              <h5 class="card-title">Mengoptimalkan Hasil Panen dengan Teknologi Smart Farming</h5>
              <p class="card-text">
                Pertanian tradisional telah mengalami banyak tantangan selama beberapa dekade terakhir...
              </p>
            </div>
            <div class="card-footer ms-auto">
              <a href="detailArtikel.html" class="btn">
                <i class="fas fa-arrow-right"></i>
              </a>
            </div>
          </div>
        </div>
        <div class="swiper-slide" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="200">
          <div class="card custom-card">
            <img src="{{ asset('images/artikel/artikel2.jpg') }}" class="card-img-top zoom" alt="Smart Farming Image">
            <div class="card-body">
              <h5 class="card-title">Tips untuk Mendapatkan Hasil Panen Padi yang Bagus</h5>
              <p class="card-text">
                Padi adalah tanaman pangan penting yang memberikan beras sebagai sumber...
              </p>
            </div>
            <div class="card-footer ms-auto">
              <a href="detailArtikel.html" class="btn">
        ...
        <div class="swiper-slide" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="200">
          <div class="card custom-card">
            <img src="{{ asset('images/artikel/artikel3.jpg') }}" class="card-img-top zoom" alt="Smart Farming Image">
            <div class="card-body">
              <h5 class="card-title">Persiapan untuk Melakukan Aktivitas Bercocok Tanam</h5>
              <p class="card-text">
                Pertanian padi adalah kegiatan penting dalam pemenuhan kebutuhan pangan...
              </p>
            </div>
            <div class="card-footer ms-auto">
              <a href="detailArtikel.html" class="btn">
        ...
        <div class="swiper-slide">
          <div class="card custom-card">
            <img src="{{ asset('images/artikel/artikel4.jpg') }}" class="card-img-top zoom" alt="Smart Farming Image">
            <div class="card-body">
              <h5 class="card-title">Perairan di Sawah: Aspek Vital dalam Pertanian Padi</h5>
              <p class="card-text">
                Sawah adalah lanskap unik yang menjadi rumah bagi pertanian padi, tanaman...
              </p>
            </div>
            <div class="card-footer ms-auto">
              <a href="detailArtikel.html" class="btn">
        ...
        <div class="swiper-slide">
          <div class="card custom-card">
            <img src="{{ asset('images/artikel/artikel5.jpg') }}" class="card-img-top zoom" alt="Smart Farming Image">
            <div class="card-body">
              <h5 class="card-title">Revolusi Pertanian Melalui Smart Farming dengan Pemanfaatan IoT</h5>
              <p class="card-text">
                Industri pertanian saat ini menghadapi berbagai tantangan, seperti...
              </p>
            </div>
            <div class="card-footer ms-auto">
              <a href="detailArtikel.html" class="btn">
        ...
        <div class="swiper-slide">
          <div class="card custom-card">
            <img src="{{ asset('images/artikel/artikel6.jpg') }}" class="card-img-top zoom" alt="Smart Farming Image">
            <div class="card-body">
              <h5 class="card-title">Bagaimana Cara Pemilihan Pupuk untuk Penanaman Padi</h5>
              <p class="card-text">
                Pupuk adalah salah satu komponen penting dalam pertanian modern, membantu petani...
              </p>
            </div>
            <div class="card-footer ms-auto">
              <a href="detailArtikel.html" class="btn">
