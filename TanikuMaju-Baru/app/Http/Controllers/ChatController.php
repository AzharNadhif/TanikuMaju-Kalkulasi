...
class ChatController extends Controller
{
    ...
    public function getByDiskusi($id_diskusi, Request $request): JsonResponse
    {
        ...
        // Ambil foto profil dari tabel 'Petani' dan tambahkan isMe pada setiap chat
        $chats = $chats->map(function ($chat) {
            // Ambil foto_profil berdasarkan id_petani dari tabel Petani
            ...
            // Menambahkan foto_profil dan foto komentar ke dalam data chat
            ...
            // Menyimpan data foto dari tabel 'Chat'
            $chat->foto = $chat->foto; // Menambahkan foto dari tabel Chat
    
            // Menyimpan komentar (isi_komentar) dari tabel 'Chat'
            $chat->isi_komentar = $chat->isi_komentar; // Ambil langsung dari kolom 'isi_komentar'
    
            // Menyimpan informasi tambahan yang belum ada sebelumnya (created_at, updated_at)
            return [
                'id' => $chat->id,
